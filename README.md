...
### 주요 기능
| **OOTD 작성 기능** | **좋아요/찜하기 기능** | **해시 태그/사용자 검색 기능** |
|:---:|:---:|:---:|
...
- **Spring Data JPA**: ORM 기반 데이터베이스 접근 및 관리
...
## 데이터베이스 설계 (ERD)
<img width="1078" height="1287" alt="image" src="https://github.com/user-attachments/assets/e8be5ffc-e405-45b9-8808-03415d89d184" />
